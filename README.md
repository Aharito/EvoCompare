...
Задаются в файле `assets/snippets/Compare/config.compare.php`, там отредактируйте и поставьте свои параметры, шаблоны, tvList, сортировку и т.д. Почти все параметры и шаблоны как у ДокЛистера, документация пока что **там же в коде, в комментариях**.
